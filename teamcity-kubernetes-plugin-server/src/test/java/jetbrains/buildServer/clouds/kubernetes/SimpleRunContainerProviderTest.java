...
public class SimpleRunContainerProviderTest extends BaseTestCase {
  ...
  public void validate_all_parameters(){
    ...
    then(container.getEnv()).hasSize(8).containsOnly(
      ...
      new EnvVar(KubeContainerEnvironment.TEAMCITY_KUBERNETES_PROVIDED_PREFIX +
                 KubeContainerEnvironment.paramToEnvVar(KubeContainerEnvironment.paramToEnvVar(KubeContainerEnvironment.STARTING_INSTANCE_ID_PARAM)), "token", null)
    );
  }
