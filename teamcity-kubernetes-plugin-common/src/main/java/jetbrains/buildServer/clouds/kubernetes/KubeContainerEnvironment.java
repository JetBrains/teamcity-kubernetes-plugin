...
public class KubeContainerEnvironment {
    ...
    public static final String TEMPORARY_AUTH_TOKEN = TEAMCITY_KUBERNETES_PREFIX + "TEMPORARY_AUTH_TOKEN";
    ...
    public static final String TEMPORARY_AUTHORIZATION_TOKEN_PARAM = "teamcity.agent.temporary.authorizationToken";
}