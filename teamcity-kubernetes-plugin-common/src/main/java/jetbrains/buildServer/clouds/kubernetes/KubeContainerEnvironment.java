...
public class KubeContainerEnvironment {
    ...
    public static final String CLOUD_INSTANCE_HASH = TEAMCITY_KUBERNETES_PREFIX + "CLOUD_INSTANCE_HASH";
    ...
    public static final String CLOUD_INSTANCE_HASH_PROP = "teamcity.cloud.instance.hash";
}